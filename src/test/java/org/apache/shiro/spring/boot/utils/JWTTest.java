...
public class JWTTest {
	...
	*/
	...
	public void applyToken1() throws Exception{ 
		...
		String token1 = JJwtUtils.genToken("HS256", base64Secret, UUID.randomUUID().toString(), "Jwt测试1", "test1", claims, 1024);
		...
		JwtPlayload jwtPlayload = JJwtUtils.playload(base64Secret, token1);
	...
	public void applyToken2() throws Exception{ 
		...
		String token2 = JJwtUtils.genToken("HS384", base64Secret, UUID.randomUUID().toString(), "Jwt测试2", "test2", 1024, "admin,stu", "user:del");
		...
		JwtPlayload jwtPlayload2 = JJwtUtils.playload(base64Secret, token2);
